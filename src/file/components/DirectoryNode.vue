...
<template>
    <div v-if="directory.parent !== undefined"
         @click="$emit('selected', directory.parent)"
    ...
    <div v-for="child in children" @click="$emit('selected', child)" class="cursor-pointer hover:text-blue-700 flex border-b border-slate-200">
