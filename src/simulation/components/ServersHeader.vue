<template>
    <div class="bg-slate-50 border-b border-slate-300 table-header">
        <h1 class="text-2xl px-10 pt-5 text-slate-700">Servers</h1>
        <div class="pt-2 px-7 flex">
            <router-link class="nav-item" :to="{name: 'simulation-server-versions-table'}">
                <icon icon="code-commit" class="mr-1 text-sm" />
                Versions
            </router-link>
        </div>
    </div>
